...
SECRET_KEY = 'django-insecure-0i#t%8zv3kee829w8qqsz%+-i+v-k3mjh4o09r11hr$=)4(!yh'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'blog_api_db',  # Name of the database
        'USER': 'atiq',  # Database user
        'PASSWORD': 'atiq12345',  # Database password
